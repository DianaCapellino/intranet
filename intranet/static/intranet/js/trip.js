    ...
    document.querySelectorAll(".edit-block").forEach(button => {
        button.addEventListener("click", function () {
            ...
            if (isEditing) {
                ...
                // ✅ Crear toggle ANTES de habilitar edición (solo en alojamiento)
                const isServicePage = !!document.querySelector('#supplier_list[data-service-type="NA"]');
                if (!isServicePage) createBlockCostToggle(blockId);
